...
export const getQuizzesByGradeThreeScience = async (req, res, next) => {
  try {
    console.log('🧬 جلب كويزات الصف الثالث الثانوي علمي...');
    ...
    console.log(`✅ تم جلب ${quizzes.length} كويز للصف الثالث علمي من أصل ${totalQuizzes}`);
    ...
    console.error('❌ خطأ في جلب كويزات الصف الثالث علمي:', error);
    next(error);
  }
};